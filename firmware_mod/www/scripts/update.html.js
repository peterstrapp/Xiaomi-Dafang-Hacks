    ...
    function showupdatepage(result) {
        $.ajax({
            ...
            if (update_status == 0) {
                ...
                $('#updatemsg').html("No version file found. <br /> You can update the running firmware on this camera by the latest available from its <a target='_blank' href='https://github.com/peterstrapp/Xiaomi-Dafang-Hacks'>Github repository</a>. <br />Settings will be retained after update.")
